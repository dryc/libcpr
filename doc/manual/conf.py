# -*- coding: utf-8 -*-
#
# libcpr documentation build configuration file, created by `sphinx-quickstart`.
#
...
html_title = "libcpr Manual"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "libcpr"
...
latex_documents = [
  ('index', 'libcpr.tex', u'libcpr Documentation',
...
texinfo_documents = [
  ('index', 'libcpr', u'libcpr Documentation',
   u'Arto Bendiken', 'libcpr', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'libcpr'
epub_author = u'Arto Bendiken'
epub_publisher = u'Arto Bendiken'
epub_copyright = u'2012, Arto Bendiken'
